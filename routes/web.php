...
Route::get('/signatures/report/{signature}/edit', [SignatureController::class, 'edit'])->name('signatures.edit');
Route::put('/signatures/report/{signature}', [SignatureController::class, 'update'])->name('signatures.update');
