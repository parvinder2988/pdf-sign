...
if ($requestPath === '/__diagnostics') {
    ...
    echo json_encode([
        ...
        'mail_mailer' => $_ENV['MAIL_MAILER'] ?? $_SERVER['MAIL_MAILER'] ?? getenv('MAIL_MAILER') ?: null,
        'mail_host' => $_ENV['MAIL_HOST'] ?? $_SERVER['MAIL_HOST'] ?? getenv('MAIL_HOST') ?: null,
        'mail_port' => $_ENV['MAIL_PORT'] ?? $_SERVER['MAIL_PORT'] ?? getenv('MAIL_PORT') ?: null,
        'mail_username_set' => (bool) ($_ENV['MAIL_USERNAME'] ?? $_SERVER['MAIL_USERNAME'] ?? getenv('MAIL_USERNAME')),
        'mail_password_set' => (bool) ($_ENV['MAIL_PASSWORD'] ?? $_SERVER['MAIL_PASSWORD'] ?? getenv('MAIL_PASSWORD')),
        'mail_from_address' => $_ENV['MAIL_FROM_ADDRESS'] ?? $_SERVER['MAIL_FROM_ADDRESS'] ?? getenv('MAIL_FROM_ADDRESS') ?: null,
